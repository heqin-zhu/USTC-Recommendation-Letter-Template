...
\documentclass[12pt]{USTCletter}
\usepackage{fontspec} 
\usepackage{tikz} 
\usepackage{xcolor}
\definecolor{ustcblue}{RGB}{30,80,180}
\usepackage{lipsum}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{eso-pic}
...
\begin{tikzpicture}
    ...
    {\includegraphics[width=0.70\textwidth]{figures/ustc_logo.pdf}};
    \end{tikzpicture}
\vfill}}}
...
\def\Where{\hspace{-1.2mm}\textbf{\color{ustcblue}%{ustcblue}
...
\def\Address{96 JinZhai RD} 
%
\def\CityZip{Hefei 230026 P.R. China} 

%

\def\Email{\textbf{\color{ustcblue}E-mail}: xxx@ustc.edu.cn}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{ustcblue}Phone}: +86 xxxx-xxxxxxx}
%
% Set your department or personal website here
\def\URL{\textbf{\color{ustcblue}URL}: http://www.ustc.edu.cn/}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
%
...
\def\school{\small{
  USTC $\cdot$
     ~School of Biomedical Engineering $\cdot$
     ~96 JinZhai RD $\cdot$
...
%
\signature{ 
\vspace{-12mm}\includegraphics[scale=0.40]{figures/signature_block.pdf}\\\vspace{-2mm}
\name}
%\signature{\name}  % [[Alternate]]
